...
from vpsmon.payment import UnionPay, AliPay, CreditCard, DebitCard, PayPal
from vpsmon.providers import Provider


class YeCaoYun(Provider):
    type = ProviderType.yecaoyun
    icon = "/provider/yecaoyun.ico"
    name = "YeCaoYun"
    homepage = "https://yecaoyun.com"
    payments = [PayPal, AliPay, UnionPay, CreditCard, DebitCard]
    datacenter_url = ""
    enable = False
    aff = 2123
    aff_url = f"https://my.yecaoyun.com/aff.php?aff={aff}"
